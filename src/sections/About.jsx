    ...
    <Section className="bg-secondary  bg-bottom pb-10 overflow-x-clip">
      ...
      >
        ...
        "
          >
            <SectionHeadMotion>
              <AnimatedText textContent={"ABOUT ME"} infinite delay={5000} />
            </SectionHeadMotion>
          </h3>

          <h3 className="font-dinw05Bold mb-4 text-xl leading-tight tracking-[-0.01em] pl-3 lg:pl-0">
            WHO AM I?
          </h3>
          <p className="font-dinw05Bold text-lg leading-snug md:max-w-lg lg:max-w-[80%] pl-3 lg:pl-0 ">
            Hey what's up. My name is German Miquere and I am looking for a full
            time position in a web devolopement company as a front-end
            developer. My main goal not only is to apply my knowleadge to boost
            the team I will join in the corporation but also to get my own
            skills to the next level in order to become a better developer.
          </p>
          <div
            className="z-30
